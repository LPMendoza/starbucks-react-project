...
const ProductDetail = ({product, handleOnClose, showed}) => {
  ...
  return (
    <div className={`bg-light cont-page-details ${showed ? "showed-details" : ""}`}>
      <div className={`bg-light container-fluid page-product-detail d-flex`}>
        <div className="row">
          ...
          <div className="col-12 col-lg-6 d-flex flex-column justify-content-center">
            ...
            <div className="col-md-10 col-12 px-0 cont-info-product mx-md-4 mb-4 mb-md-0">
              ...
              <p className="text-primary product-price-detail mb-5">${parseFloat(product != null ? product.price : "").toFixed(2)}</p>

              <button className="mr-lg-0 btn btn-primary rounded-pill px-md-5 py-3">AGREGAR AL CARRITO
